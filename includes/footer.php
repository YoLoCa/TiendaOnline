...
<h3>Vinyl Store</h3>
     ...
     <div class="module-body m-t-20">
        <p class="about-us"> Vinyl Store, las música siempre cerca de tí</p>
        ...
        <a href="https://google.com"><i class="icon fa fa-rss"></i></a>
        ...
        <ul class="toggle-footer">
            <li class="media">
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <p>(+34) 948445199<br>(+34) 948445199</p>
                </div>
            </li>
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <span><a href="#">vinylstore@vinyl.com</a></span>
                </div>
            </li>
