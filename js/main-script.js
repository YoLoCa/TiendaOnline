...
window.onload = document.forms[2].addEventListener("click", suscribirse); 
function suscribirse(){
event.preventDefault();
let email = document.forms[2].mail.value;
document.getElementById('suscrito').innerHTML = `Recibirás nuestro boletin y te mantendremos informado: ${email}`; 
	} 